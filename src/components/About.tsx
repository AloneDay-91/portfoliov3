          ...
          <div className="flex flex-col md:flex-row items-center justify-start">
              ...
              <div className="flex flex-col md:justify-start justify-center items-center md:items-start">
                ...
                <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl dark:shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block my-6 max-w-80">
                  ...
                  <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-100 dark:bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
                    <a
                      href="https://linkedin.com/in/elouanbruzek/"
                      target="_blank"
                    >
                      <span className="flex items-center gap-2 dark:text-emerald-400/90 text-emerald-700/90">
                        <span className="relative flex size-3">
                          <span className="absolute inline-flex size-full animate-ping rounded-full opacity-75 dark:bg-emerald-400/80 bg-emerald-800/80"></span>
                          <span className="relative inline-flex size-3 scale-90 rounded-full dark:bg-emerald-500/80 bg-emerald-900/80"></span>
                        </span>
            ...
            <div className="w-full text-justify md:text-left md:w-2/5">
              <p className="text-lg text-muted-foreground">
                ...
                deuxième année de BUT MMI à Troyes.
                <div className="inline-flex overflow-hidden px-2">
                  <p>
                    <WordRotate
                      className="text-lg font-bold text-black dark:text-white"
                      words={["Dynamique", "Curieux", "Rigoureux", "Serieux"]}
                    />
                  </p>
                </div>
                et toujours en quête d'apprentissage, je m'investis dans des
                projets personnels et collabore sur diverses initiatives pour
                affiner mes compétences techniques et créatives.
              </p>
            </div>
          </div>
        </section>
