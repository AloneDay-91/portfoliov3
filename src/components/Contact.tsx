            ...
            <section className="relative max-w-screen-2xl mx-auto border-l border-r w-full py-12 px-12 gap-8">
                ...
                <div className="flex items-center justify-start">
                    <div className="w-auto md:w-1/4">
                        <span className="text-muted-foreground text-xl md:text-2xl flex items-center gap-4"><Linkedin size={24} strokeWidth={2} /> Linkedin</span>
                    </div>
                    <div className="flex items-start">
                        <Button variant="link" asChild className="font-medium text-xl md:text-2xl text-left">
                ...
                <div className="flex items-center justify-start">
                    <div className="w-auto md:w-1/4">
                        <span className="text-muted-foreground text-xl md:text-2xl flex items-center gap-4"><Mails size={24} strokeWidth={2} /> Email</span>
                    </div>
                    <div className="flex items-start">
                        <Button variant="link" asChild className="font-medium text-xl md:text-2xl text-left">
                ...
                <div className="flex justify-start items-center">
                    <div className="w-auto md:w-1/4">
                        <span className="text-muted-foreground text-xl md:text-2xl flex items-center gap-4"><Github size={24} strokeWidth={2} /> Github</span>
                    </div>
                    <div className="flex items-start">
                        <Button variant="link" asChild className="font-medium text-xl md:text-2xl text-left">
