...
export function DivideTitle({ title, id }: { title: string; id?: string }) {
    return (
        <div className="border-grid flex flex-1 flex-col items-center" id={id}>
            <div className="border-grid sticky top-0 w-full border-b border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
