                  ...
                  <div className="text-muted-foreground  leading-6 text-md">
                    <p>
                      <DecryptedText
                        ...
                        speed={20}
                        sequential={true}
                        text="Bachelor Universitaire de Technologie (Métiers du Multimédia et de l’Internet)"
                      />
                    </p>
                    <p>
                      <DecryptedText
                        ...
                        speed={20}
                        sequential={true}
                        text="Parcours Développement web et dispositifs interactifs"
                      />
                    </p>
                  </div>
                </div>
                  ...
                  <div className="text-muted-foreground  leading-6 text-md">
                    <p>
                      <DecryptedText
                        ...
                        speed={20}
                        sequential={true}
                        text="Bachelor Universitaire de Technologie (Informatique)"
                      />
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                  <h2 className="font-medium text-2xl">
                    <DecryptedText
                      ...
                      speed={50}
                      sequential={true}
                      text="Lycée Rosa Parks - Montgeron"
                    />
                  </h2>
                  <div className="text-muted-foreground  leading-6 text-md">
                    <p>
                      <DecryptedText
                        ...
                        speed={20}
                        sequential={true}
                        text="Baccalauréat STI2D mention Assez Bien"
                      />
                    </p>
                    <p>
                      <DecryptedText
                        ...
                        speed={20}
                        sequential={true}
                        text="Système informatique et numérique (SIN)"
                      />
                    </p>
                  </div>
                </div>
